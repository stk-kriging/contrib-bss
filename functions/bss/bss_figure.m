...
% fig_ax_ay %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function [ax, ay] = fig_ax_ay (xt, xi, input_distrib)  %#ok<INUSD>
...
% Common subfunctions for figure 21, 220, 221, 30 %%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ~ isequal (u_target, u_final)
        ...
        contour (xg1, xg2, z, [u_target u_target], CONTOUR_TL{:});

        % Intermediate stage / final level
        contour (xg1, xg2, z, [u_final u_final], CONTOUR_FL{:});

    else

        % Final stage / final level
        contour (xg1, xg2, z, [u_final u_final], CONTOUR_TL{:});
    ...
    contour(xg1, xg2, z, u_target_prev, 'Color', 'k', 'LineStyle', '--');
...
% FIGURE 221 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function figure_x1_x2_C ...
        (xt, xi, idx_new, u_target_prev, u_target, ...
        problem, stage, Pf_target_estim)  %#ok<INUSD>
